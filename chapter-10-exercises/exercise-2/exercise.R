...
salaries$got_rise <- salaries$salaries_2018 > salaries$salary_adjustments
...
salary_57 <- salaries[salaries$employees == "Emplayee 57", "salaries_2018"]
...
got_biggest_decrease <- salaries[salaries$salary_adjustments == biggest_decrease, "employees"]
